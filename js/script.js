...
function optionSelected(answers) {
    ...
    if (userAns == correctAns) {
        ...
        answers.insertAdjacentHTML("beforeend", tickIcon);
    } else {
        answers.classList.add("incorrect");
        console.log("Answer Is Incorrect");
        answers.insertAdjacentHTML("beforeend", crossIcon);

        //ifanswers is incorreect then automatically select the correct answer
...
function showResultBox(){
    ...
    result_box.classList.add("activeResult");//show the info box
...
function queCounter(index) {
    ...
    let totalQuestCountTag = '<span><p>' + index + '</p><p>of</p><p>' + questions.length + '</p><p>Questions</p></span>'
    button_ques_counter.innerHTML = totalQuestCountTag;
}